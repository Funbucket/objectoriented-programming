...
TEST(test1, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test1_root), "StringNode(here, StringNode(hello, NULL, NULL), StringNode(world, NULL, NULL))");
}
...
TEST(test2, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test2_root),
...
TEST(test3, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test3_root),
...
TEST(test4, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test4_root),
...
TEST(test5, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test5_root), "StringNode(hello, NULL, NULL)");
}
...
TEST(test6, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test6_root), "StringNode(hello, StringNode(world, NULL, NULL), NULL)");
}
...
TEST(test7, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test7_root), "StringNode(hello, NULL, StringNode(world, NULL, NULL))");
}
...
TEST(test8, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test8_root), "IntNode(1, StringNode(hello, StringNode(world, NULL, NULL), NULL), NULL)");
}
...
TEST(test9, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test9_root), "StringNode(hello, StringNode(world, NULL, NULL), IntNode(2, NULL, IntNode(1, NULL, NULL)))");
}
...
TEST(test10, ToStringTest) {
    EXPECT_EQ(tree_util->ToString(&test10_root), "StringNode(hello, StringNode(here, NULL, IntNode(2, NULL, NULL)), IntNode(1, NULL, StringNode(world, NULL, NULL)))");
}
